        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TestTemplate10DbContext>)));
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate10DbContext>();
        ...
        public TestTemplate10DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate10DbContext> _options;
            ...
            {
                _options = new DbContextOptionsBuilder<TestTemplate10DbContext>()
            ...
            public TestTemplate10DbContext BuildContext() =>
                new(_options);
        }
    }
}
