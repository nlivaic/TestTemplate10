...
using TestTemplate10.Common.MessageBroker.Middlewares.ErrorLogging;
using TestTemplate10.Common.MessageBroker.Middlewares.Tracing;
using TestTemplate10.Core;
using TestTemplate10.Core.Events;
using TestTemplate10.Data;
using TestTemplate10.WorkerServices.FaultService;
using TestTemplate10.WorkerServices.FooService;
...
namespace TestTemplate10.WorkerServices
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Starting up TestTemplate10 Worker Services.");
            ...
            {
                Log.Fatal(ex, "TestTemplate10 Worker Services failed at startup.");
            }
            finally
            {
                Log.CloseAndFlush();
