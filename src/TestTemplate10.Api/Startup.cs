...
namespace TestTemplate10.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            if (!string.IsNullOrEmpty(_configuration["APPLICATIONINSIGHTS_CONNECTION_STRING"]))
            {
                services
                    ...
                    //            ResourceBuilder
                    //                .CreateDefault()
                    //                .AddService(serviceName: "TestTemplate10"))
                    //        .AddAspNetCoreInstrumentation()
            ...
            services.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    "TestTemplate10OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate10 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate10.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate10.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate10Client", builder =>
            {
            ...
            services.AddMassTransit(x =>
            {
                ...
                x.AddEntityFrameworkOutbox<TestTemplate10DbContext>(o =>
                {
            ...
            services.AddTestTemplate10ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate10DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate10Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate10OpenAPISpecification/swagger.json", "TestTemplate10 API");
